...
check_file "/src/domain/traffic_test/evaluator.rs" 95 "traffic evaluator"
check_file "/src/domain/traffic_test/projection.rs" 95 "candidate projector"
check_file "/src/application/traffic_test.rs" 90 "traffic coordinator"
check_file "/src/infrastructure/traffic_test_store.rs" 90 "traffic suite storage"
